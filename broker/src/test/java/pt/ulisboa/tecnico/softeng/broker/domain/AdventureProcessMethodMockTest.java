...
public class AdventureProcessMethodMockTest {
    ...
    @Test
    public void reserveHotelWithHotelException(@Mocked final BankInterface bankInterface,
                                               @Mocked final HotelInterface hotelInterface) {
        new Expectations() {
            {
                BankInterface.processPayment(IBAN, 300);
    ...
    @Test
    public void reserveActivityWithActivityException(@Mocked final BankInterface bankInterface,
                                                     @Mocked final HotelInterface hotelInterface,
                                                     @Mocked final ActivityInterface activityInterface) {
        new Expectations() {
            {
